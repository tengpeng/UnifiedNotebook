...
var JupyterKernel = /** @class */ (function () {
    ...
    JupyterKernel.prototype.interrupt = function () {
        var _a, _b;
        (_b = (_a = this.session) === null || _a === void 0 ? void 0 : _a.kernel) === null || _b === void 0 ? void 0 : _b.interrupt();
    };
    JupyterKernel.prototype.shutdown = function () {
        var _a, _b;
        (_b = (_a = this.session) === null || _a === void 0 ? void 0 : _a.kernel) === null || _b === void 0 ? void 0 : _b.shutdown();
    };
