...
/* -------------------------------------------------------------------------- */
var Zeppelin = /** @class */ (function () {
    function Zeppelin(server, port) {
    ...
    Zeppelin.prototype.sendMsg = function (method, url, msg) {
    ...
    Zeppelin.prototype.handleResponse = function (res) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var json;
    ...
    Zeppelin.prototype.createNote = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Zeppelin.prototype.deleteNote = function (noteId) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Zeppelin.prototype.createParagraph = function (paragraphId, text) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Zeppelin.prototype.runParagraph = function (noteId, paragraphId) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Zeppelin.prototype.listNote = function () {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Zeppelin.prototype.deleteAllNote = function () {
        return __awaiter(this, void 0, void 0, function () {
            var noteList;
            var _this = this;
            return __generator(this, function (_a) {
